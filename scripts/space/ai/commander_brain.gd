...
## GOAP-style planner for commanders.
## AssessAction always qualifies — the commander always produces a decision.

const PLAN_LOCK_DURATION          = 1.2
const PRIORITY_OVERRIDE_THRESHOLD = 0.5


static func decide(ws: CommanderWorldState, game_time: float) -> Dictionary:
