...
## Rotate point 90 degrees clockwise (to make ships horizontal)
func _rotate_90(point: Vector2) -> Vector2:
	return Vector2(-point.y, point.x)

func _draw_fighter_hull(ship_data: Dictionary, center: Vector2, scale: float) -> void:
	# Fighter: elongated triangle shape (rotated 90° to be horizontal)
	var size = 15.0 * scale
	...
	front_line.add_point(center + _rotate_90(Vector2(0, nose_y)))  # Nose
	front_line.add_point(center + _rotate_90(Vector2(-width * 0.5, mid_y)))  # Left mid
	front_line.add_point(center + _rotate_90(Vector2(width * 0.5, mid_y)))  # Right mid
	front_line.add_point(center + _rotate_90(Vector2(0, nose_y)))  # Back to nose
	...
	front_label.position = center + _rotate_90(Vector2(-15, nose_y * 0.5))
	...
	back_line.add_point(center + _rotate_90(Vector2(-width * 0.5, mid_y)))  # Left mid
	back_line.add_point(center + _rotate_90(Vector2(-width * 0.4, tail_y)))  # Left tail
	back_line.add_point(center + _rotate_90(Vector2(width * 0.4, tail_y)))  # Right tail
	back_line.add_point(center + _rotate_90(Vector2(width * 0.5, mid_y)))  # Right mid
	back_line.add_point(center + _rotate_90(Vector2(-width * 0.5, mid_y)))  # Back to left mid
	...
	back_label.position = center + _rotate_90(Vector2(-15, mid_y + 10))
	ship_canvas.add_child(back_label)

func _draw_corvette_hull(ship_data: Dictionary, center: Vector2, scale: float) -> void:
	# Corvette: hammerhead front, thin body, thick rear (rotated 90° to be horizontal)
	var size = 25.0 * scale
	...
	front_line.width = 1.5
	front_line.default_color = COLOR_ARMOR
	front_line.add_point(center + _rotate_90(Vector2(-hammer_width * 0.5, front_y)))
	front_line.add_point(center + _rotate_90(Vector2(hammer_width * 0.5, front_y)))
	front_line.add_point(center + _rotate_90(Vector2(body_width * 0.5, front_mid_y)))
	front_line.add_point(center + _rotate_90(Vector2(-body_width * 0.5, front_mid_y)))
	front_line.add_point(center + _rotate_90(Vector2(-hammer_width * 0.5, front_y)))
	ship_canvas.add_child(front_line)
	...
	front_label.text = "front"
	front_label.add_theme_color_override("font_color", COLOR_ARMOR)
	front_label.position = center + _rotate_90(Vector2(-20, front_y + 5))
	ship_canvas.add_child(front_label)
	...
	mid_line.add_point(center + _rotate_90(Vector2(-body_width * 0.5, front_mid_y)))
	mid_line.add_point(center + _rotate_90(Vector2(body_width * 0.5, front_mid_y)))
	mid_line.add_point(center + _rotate_90(Vector2(body_width * 0.5, rear_mid_y)))
	mid_line.add_point(center + _rotate_90(Vector2(-body_width * 0.5, rear_mid_y)))
	mid_line.add_point(center + _rotate_90(Vector2(-body_width * 0.5, front_mid_y)))
	...
	mid_label.position = center + _rotate_90(Vector2(body_width * 0.5 + 5, 0))
	...
	back_line.add_point(center + _rotate_90(Vector2(-body_width * 0.5, rear_mid_y)))
	back_line.add_point(center + _rotate_90(Vector2(-rear_width * 0.5, rear_mid_y + (rear_y - rear_mid_y) * 0.3)))
	back_line.add_point(center + _rotate_90(Vector2(-rear_width * 0.4, rear_y * 0.85)))
	back_line.add_point(center + _rotate_90(Vector2(0, rear_y)))
	back_line.add_point(center + _rotate_90(Vector2(rear_width * 0.4, rear_y * 0.85)))
	back_line.add_point(center + _rotate_90(Vector2(rear_width * 0.5, rear_mid_y + (rear_y - rear_mid_y) * 0.3)))
	back_line.add_point(center + _rotate_90(Vector2(body_width * 0.5, rear_mid_y)))
	back_line.add_point(center + _rotate_90(Vector2(-body_width * 0.5, rear_mid_y)))
	...
	back_label.position = center + _rotate_90(Vector2(-20, rear_y - 10))
	ship_canvas.add_child(back_label)

func _draw_capital_hull(ship_data: Dictionary, center: Vector2, scale: float) -> void:
	# Capital: Star Destroyer triangle - narrow nose to wide back (rotated 90° to be horizontal)
	var size = 50.0 * scale
	var length = size * 3.6
	...
	outline.add_point(center + _rotate_90(Vector2(0, nose_y)))
	outline.add_point(center + _rotate_90(Vector2(width_at_back * 0.5, back_y)))
	outline.add_point(center + _rotate_90(Vector2(-width_at_back * 0.5, back_y)))
	outline.add_point(center + _rotate_90(Vector2(0, nose_y)))
	...
	div1.add_point(center + _rotate_90(Vector2(-width_at_front * 0.5, front_split_y)))
	div1.add_point(center + _rotate_90(Vector2(width_at_front * 0.5, front_split_y)))
	...
	div2.add_point(center + _rotate_90(Vector2(-width_at_middle * 0.5, middle_split_y)))
	div2.add_point(center + _rotate_90(Vector2(width_at_middle * 0.5, middle_split_y)))
	...
	centerline.add_point(center + _rotate_90(Vector2(0, nose_y)))
	centerline.add_point(center + _rotate_90(Vector2(0, back_y)))
	...
	for i in range(labels_text.size()):
		...
		label.position = center + _rotate_90(labels_pos[i])
